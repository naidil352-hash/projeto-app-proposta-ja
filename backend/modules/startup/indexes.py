...
INDEX_SPECS: tuple[tuple[str, Any, dict[str, Any]], ...] = (
    ...
    ("outbound_webhooks", [("company_id", 1), ("id", 1)], {"unique": True}),
    ("outbound_webhooks", [("company_id", 1), ("enabled", 1), ("events", 1)], {}),
    ("outbound_webhook_deliveries", [("company_id", 1), ("created_at", -1)], {}),
    ("outbound_webhook_deliveries", [("company_id", 1), ("webhook_id", 1), ("event_id", 1)], {"unique": True}),
